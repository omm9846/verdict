...
```
Subject: smartlead.ai accepts every address (including ones that don't exist)
...
Smartlead came back with something you probably want to know.

smartlead.ai is catch-all — it accepted a random 22-character mailbox I invented on the spot. That means no verifier can confirm any individual address on it, including ours, and including whatever you're using.
