# pavilion.com — pitch pack

- mail server: `smtp.secureserver.net`
- checked: 2026-08-29T15:17:36+00:00
...
- `contact@pavilion.com` — probe-ip blocked: Connection unexpectedly closed
- `editor@pavilion.com` — probe-ip blocked: Connection unexpectedly closed
- `editorial@pavilion.com` — probe-ip blocked: Connection unexpectedly closed
- `hello@pavilion.com` — probe-ip blocked: Connection unexpectedly closed
- `info@pavilion.com` — probe-ip blocked: Connection unexpectedly closed
- `news@pavilion.com` — probe-ip blocked: Connection unexpectedly closed
- `newsdesk@pavilion.com` — probe-ip blocked: Connection unexpectedly closed
- `press@pavilion.com` — probe-ip blocked: Connection unexpectedly closed
- `team@pavilion.com` — probe-ip blocked: Connection unexpectedly closed
- `tips@pavilion.com` — probe-ip blocked: Connection unexpectedly closed
