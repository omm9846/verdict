# bytes.dev — pitch pack

- mail server: `bytes.dev`
- checked: 2026-08-29T15:16:23+00:00
...
- `contact@bytes.dev` — timed out
- `editor@bytes.dev` — timed out
- `editorial@bytes.dev` — timed out
- `hello@bytes.dev` — timed out
- `info@bytes.dev` — timed out
- `news@bytes.dev` — timed out
- `newsdesk@bytes.dev` — timed out
- `press@bytes.dev` — timed out
- `team@bytes.dev` — timed out
- `tips@bytes.dev` — timed out
