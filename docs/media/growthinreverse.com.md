# growthinreverse.com — pitch pack

- mail server: `smtp.google.com`
- checked: 2026-08-29T15:17:28+00:00

> catch-all domain: every address is accepted, so a SEND here is not proof the mailbox is read. Prefer a named journalist.
