# emailonacid.com — pitch pack

- mail server: `emailonacid-com.mail.protection.outlook.com`
- checked: 2026-08-29T15:15:46+00:00
...
<details><summary>10 unverifiable (server refused the probe — may still be fine)</summary>

- `contact@emailonacid.com` — probe-ip blocked: 5.7.1 Service unavailable, Client host [103.249.234.
- `editor@emailonacid.com` — probe-ip blocked: 5.7.1 Service unavailable, Client host [103.249.234.
- `editorial@emailonacid.com` — probe-ip blocked: 5.7.1 Service unavailable, Client host [103.249.234.
- `hello@emailonacid.com` — probe-ip blocked: 5.7.1 Service unavailable, Client host [103.249.234.
- `info@emailonacid.com` — probe-ip blocked: 5.7.1 Service unavailable, Client host [103.249.234.
- `news@emailonacid.com` — probe-ip blocked: 5.7.1 Service unavailable, Client host [103.249.234.
- `newsdesk@emailonacid.com` — probe-ip blocked: 5.7.1 Service unavailable, Client host [103.249.234.
- `press@emailonacid.com` — probe-ip blocked: 5.7.1 Service unavailable, Client host [103.249.234.
- `team@emailonacid.com` — probe-ip blocked: 5.7.1 Service unavailable, Client host [103.249.234.
- `tips@emailonacid.com` — probe-ip blocked: 5.7.1 Service unavailable, Client host [103.249.234.
