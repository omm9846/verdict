# console.dev — pitch pack

- mail server: `aspmx.l.google.com`
- checked: 2026-08-29T15:16:04+00:00

## Send to (verified live)

- **hello@console.dev** — 2.1.5 OK d2e1a72fcca58-856a4931897si9040360b3a.154 - gsmtp

**Do not use — confirmed dead:**
- ~~contact@console.dev~~ 5.1.1 The email account that you tried to reach do
- ~~editor@console.dev~~ 5.1.1 The email account that you tried to reach do
- ~~editorial@console.dev~~ 5.1.1 The email account that you tried to reach do
- ~~info@console.dev~~ 5.1.1 The email account that you tried to reach do
- ~~news@console.dev~~ 5.1.1 The email account that you tried to reach do
- ~~newsdesk@console.dev~~ 5.1.1 The email account that you tried to reach do
- ~~press@console.dev~~ 5.1.1 The email account that you tried to reach do
- ~~team@console.dev~~ 5.1.1 The email account that you tried to reach do
- ~~tips@console.dev~~ 5.1.1 The email account that you tried to reach do
